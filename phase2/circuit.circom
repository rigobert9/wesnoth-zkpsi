...
// TODO : comme le type d'action est dans les multiplexers, faire passer à une
// représentation du type en binaire direct
...
template Final(state_size, state_height, state_width, actions_size, enum_tag, enum_data, mimc_hash_size,
  ...
  * [argent_possede, villages_possédés, upkeep_accumulé] */
  ...
  // TODO: revérifier dans le papier et ici
  // https://www.zellic.io/blog/zk-friendly-hash-functions/#zk-friendly-hash-functions
  // Que c'est la bonne valeur pour k
